...
class InterventionOptimizer:
    ...
    def optimize_intervention(self, user_id, context, recommendation):
        ...
        return {
            ...
            'format': format,
            'intensity': intensity,
            'delivery': self._optimize_delivery(context)
        }
...
class UserProfile:
    ...
    def get_personalization_factors(self):
        return {
            'preferred_timing': self._get_optimal_timing(),
            'message_style': self._get_message_style(),
            'intervention_frequency': self._get_frequency(),
